...
?>
	...
	<div id="header">
		...
		{	//<li><a href='$ip/administrador/vermo.php?matricula=$usuario' >Datos</a></li><li><a href='$ip/evadoc151/horalumno.php?matricula=$usuario'>Horario</a></li>
			...
			echo"
			<header id='titulo'> 
			Alumno:$usuario / $d->app $d->apm $d->nom Periodo: $periodo";
		...
		else
		{
			...
			<div id='nav'>
                  ...
                  <ul>
										...
										<li><a href='$ip/scriptAuditoria/index.php'>Generar Script</a></li>
                  </ul>
                </div> 
							</li>
							<li><a href='$ip/cerrarsesion.php' >Salir</a></li>
            </ul>
          </div>
        </div>    

...
<div id="cuerpo">
	...
	<section id="seccion">
        ...
        <header id="header">
            <div class="subtitulo">Búsqueda de materia para alta de Horario <?php echo"$periodo a $idg"?></div>
            <br>
        </header>

        <div id="registros" >
        
        <form action="buscamateria.php" method="get" name="form1" >
        <table>
            <tr>
		...
		if(!empty($nommat))
		{
			...
			{$x++;
				...
				<tr>
					...
					<td>$b->nommat </td>
					<td>$b->idcar </td>
					<td> <a href='agregah.php?idmat=$b->idmat&idoc=$idoc&idcar=$idcar&idg=$idg' target='_self'>Selec</a> </td>
				</tr>
				";
			}

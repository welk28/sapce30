...
<div id="cuerpo">
    ...
    <header id="header">
			<div class="subtitulo">Consulta/modificacion de datos de <br><?php echo"<b>matricula: $matricula $d->app $d->apm $d->nom</b> "; 
        //<a href='boleta.php?matricula=$matricula' target='_self' >Boleta</a>
      ?></div>
        <br>
    </header>

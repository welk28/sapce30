...
<div id="cuerpo">
	...
	$bandera=0;
	$proc=$_POST[proc];
	$actualiza="update alumnos set nom='$nom', app='$app', apm='$apm', sexo='$sexo', curp='$curp', dialecto='$dialecto', fecnac= '$fecnac', edociv='$edociv', otro='$otro', calle='$calle', colonia='$colonia', idedo='$idedo', ciudad='$ciudad', cp= '$cp', telal='$telal', email='$email', idesc='$idesc', otesc='$otesc', prepa='$prepa', propre='$propre', secu='$secu', prose='$prose', idcar='$idcar', passal=sha1('$fecnac'), status='$status', nomtut='$nomtut', dirtut='$dirtut', teltut='$teltut', discap='$discap', proc='$proc' where matricula='$matricula';";

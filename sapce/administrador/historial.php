...
if($ses==2)
{
  echo"<a href='reticula_calificacion.php?matricula=$matricula&idcar=$ad->idcar' target='_blank'>Retícula</a>";
    ...
    <header id="header">
      ...
      <div class="subtitulo2" align="center">KARDEX</div>
      <br>
    ...
    <table>
      ...
      <?php
  		...
  		while($mc=mysql_fetch_object($maca))
  		{
  			...
  			if($nm>1)
  			{
  				$aprobados="select * from horario as h, cursa as c, materias as m where h.idmat=m.idmat and  h.idh=c.idh and matricula='$matricula' and h.idmat='$mc->idmat' and h.periodo!='$periodo' order by c.idh desc LIMIT 0,1;";

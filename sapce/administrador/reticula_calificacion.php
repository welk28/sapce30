        ...
        <?php
            ...
            {	echo"<tr>";				
				...
				if($c<=$nt)
				{
					...
					{
						$buscarhorario="select idh from horario where periodo='$periodo' and idmat='$r1->idmat';";
						$encuentra=mysql_query($buscarhorario,$conexion);
						$encu=mysql_fetch_object($encuentra);
						echo"<td valign='bottom'>";
						echo"<a href='agregar_a_grupo.php?matricula=$matricula&idh=$encu->idh&idcar=$idcar' target='_blank' class='agregar'> Agregar </a> ";
					}
				...
				if($c<=$nt)
				{
					...
					else
					{
						...
						$encu=mysql_fetch_object($encuentra);
						echo"<td valign='bottom'>";
						echo"<a href='agregar_a_grupo.php?matricula=$matricula&idh=$encu->idh&idcar=$idcar&idcar=$idcar' class='agregar'> Agregar </a> ";
					}
					echo"<p class='materia'>$r1->nommat</p> <p class='idmat'>$r1->idmat</p>
					<table class='nums' >
						<tr>

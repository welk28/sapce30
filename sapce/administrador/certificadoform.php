...
<div id="registros" >
    ...
    <table>
      ...
      <tr>
        <td colspan="10" align="center">
          <input name="fechaexp" type="date" size="80" maxlength="80" placeholder="Fecha de expedición" value="<?php echo"$ef->fechaexp"; ?>" required> <br> Fecha de expedición
        </td>
      </tr>
      <tr>
        <td colspan="10" align="center">&nbsp;</td>
    ...
    //echo"<h1>aqui en guardar</h1>";
		$actualiza="update certificado set  numero='$numero', libro='$libro', foja='$foja', fecha='$fecha', fechaexp='$fechaexp', periodo='$periodo' where matricula='$matricula';";
      ...
      //echo"<h1>guardado</h1>";
        ...
        <script>
            ...
            window.location.href='$ip/administrador/certificado.php?matricula=$matricula';
        </script>
      ";
		}
		else

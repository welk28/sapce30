...
<div id="cuerpo">
    ...
    <header id="header">
			<div class="subtitulo">Carga de matrícula Ing. Admnistración <?php echo"$periodo: $p->descper"?></div>
        <br>
    </header>
    ...
    <table>
        ...
        <?php
		$alumnos="select a.matricula, a.curp, a.app, a.apm, a.nom, a.status, a.propre, a.fecnac, a.sexo, h.idmat, m.nommat, c.opor, c.prom  from materias as m, alumnos as a, horario as h, cursa as c where c.prom<70 and m.idmat=h.idmat and h.idh=c.idh and a.matricula=c.matricula and a.idcar='IADM-2010-213' and h.periodo='$periodo' order by a.idcar, a.matricula, a.status;";

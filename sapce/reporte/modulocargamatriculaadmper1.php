...
<div id="cuerpo">
    ...
    <header id="header">
			<div class="subtitulo">Lista de alumnos inscritos en el semestre actual IADM-2010-213 <?php echo"$periodo: $p->descper"?></div>
        <br>
    </header>
    ...
    <table>
    	<tr>
            ...
            <td width="50">prom_a</td>
            <td width="50">prom_g</td>
            <td width="50">creditos</td>
            <td width="50">ss</td>
            <td width="200">email</td>
        </tr>
        <?php
		$alumnos="select distinct a.matricula, a.curp, a.app, a.apm, a.nom, a.status, a.propre, a.fecnac, a.sexo, a.idcar, a.email  from alumnos as a, horario as h, cursa as c where h.idh=c.idh and a.matricula=c.matricula and a.idcar='IADM-2010-213' and h.periodo='$periodo' order by a.idcar, a.status;";

    ...
    <div id="registros" >
	    ...
	    while($s=mysql_fetch_object($serv))
	    {
	    	echo"<tr>
	    		...
	    		if($ne<1)
	    			echo"<td><a href='altaserv1.php?idser=$s->idser'>Generar Auditoria</a></td>";
	    		else
	    			echo"<td></td>";
						
	    		echo"
				<td><a href='alumnoaudita.php?noev=$ev->noev'>Ver</a></td>
				<td><a href='informe.php?noev=$ev->noev'>Ver</a></td>
	    		";
	    	echo"</tr>";
	    }
    	?>		

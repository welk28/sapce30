    ...
    <div id="registros" >
    	<table>
    		<tr>
    			...
    			<th width='250'>EQUIPO AUDITOR</th>
	    	...
	    	while($s=mysql_fetch_object($num))
	    	{
	    		echo"<tr>
                    ...
                    while($q=mysql_fetch_object($equi))
                        echo"<a href='quitaequipo.php?idoc=$q->idoc&noev=$s->noev'>$q->nomdoc </a> / $q->descp <br>";
                    echo"</td>
	    			<td><a href='altaequipo.php?noev=$s->noev&descs=$s->descs'> $s->descs </a></td>
	    		</tr>";
	    	}
	    }
    	?>		

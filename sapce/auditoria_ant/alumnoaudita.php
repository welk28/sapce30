	...
	if(($ses==1)||($ses==6))
{
    ...
    <header id="header">
	  <div id="revision">
               <br>
                <table  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
                  <tr>
                    ...
                    <td width="800px" rowspan="2" align="left"><strong>Formato para el programa anual de encuesta de servicios.</                    strong></td>
                    <td width="180px" >CODIGO </td> 
                  </tr>
                  <tr>
	   ...
	   <div class="subtitulo" align="center">PROGRAMA ANUAL DE ENCUESTAS Y SERVICIOS 2015</div>
        <br>
    </header>

...
<?php       
    	print"<script type='text/javascript' src='$ip/js/jquery-1.8.1.min.js'></script>   
        <script type='text/javascript' src='$ip/js/approot.js'></script>    ";
?>
...
?>
	...
	<div id="header">
		...
		{	//<li><a href='$ip/administrador/vermo.php?matricula=$usuario' >Datos</a></li><li><a href='$ip/evadoc151/horalumno.php?matricula=$usuario'>Horario</a></li>
			...
			echo"
			<header id='titulo'> 
			Alumno:$usuario / $d->app $d->apm $d->nom Periodo: $perevadoc";
			...
			<div id='nav'>
                    <div id='nav-bar'>
                        <ul>
                            <li><a href='$ip/docente20/horalumno.php?matricula=$usuario' >Horario</a></li>
                            <li><a href='$ip/docente20/cerrarsesion.php' >Cerrar Sesión</a></li>
                        </ul>
                    </div>
                </div>    
			";?>
							...
							<li><a href='#' >Alumnos</a>   
								<div class='submenu'> 
                                    <ul>
								    	...
								    	<li><a href='$ip/administrador/egresado.php'>Egresados</a></li>
										<li><a href='$ip/administrador/egresadopromedio.php'>Egresados Mejor Promedio</a></li>	
                                    </ul>
                                </div> 
							</li>
						   	...
						   	<li> <a href='#' class=''>Reportes</a>    
                                <div id='galeria-submenu' class='submenu' style='display: none;'>
                                    <div class='left'>
                                    	<h3>General</h3>
                                        <ul>
                                            <li><a href='$ip/reporte/2020adm.php' target='_blank'>Administracion 14 </a></li>
                                            <li><a href='$ip/reporte/2020log.php' target='_blank'>Logistica  14</a></li>
                                            <li><a href='$ip/reporte/2020tic.php' target='_blank'>TICS  14</a></li>

                                            <li><a href='$ip/reporte/01_repcovidtic.php' target='_blank'>PostCovid Tics Reprob</a></li>
                                            <li><a href='$ip/reporte/01_repcovidadm.php' target='_blank'>PostCovid Adm Reprob</a></li>
                                            <li><a href='$ip/reporte/01_repcovidlog.php' target='_blank'>PostCovid Log Reprob</a></li>
                                            <li><a href='$ip/reporte/00_repcovidtic.php' target='_blank'>PostCovid Tics</a></li>
                                            <li><a href='$ip/reporte/00_repcovidadm.php' target='_blank'>PostCovid Adm</a></li>
                                            <li><a href='$ip/reporte/00_repcovidlog.php' target='_blank'>PostCovid Log</a></li>
                                            <li><a href='$ip/reporte/kardexglobal.php' target='_blank'>Kardex Global 2013/actual</a></li>
                                   ...
                                   <div class='left'>
                                    	<h3>General<h3>
                                        <ul>
                                            <li><a href='$ip/reporte/rplogdetalle.php' target='_blank'>Detalle Logistica</a></li>
                                            <li><a href='$ip/reporte/rpadmdetalle.php' target='_blank'>Detalle Administracion</a></li>
                                            ...
                                            <li><a href='$ip/reporte/ddpinal.php' target='_blank'>DDPI Nacional</a></li>
                                            <li><a href='$ip/reporte/cargaconcentrado.php' target='_blank'>Carga Concentrado</a></li>
                                            <li><a href='$ip/reporte/rpticdetalle.php' target='_blank'>Detalle Tics</a></li>
                                        </ul>
                                  </div>
								   ...
								   <div class='left'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href='$ip/reporte/inscritoxciudad.php'>Inscritos por Ciudad</a></li>
                                ...
                                <div id='galeria-submenu' class='submenu' style='display: none;'>
                                    <div class='left'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href='$ip/administrador/semp.php' >Semi Presencial</a></li>
                                ...
                                <div id='galeria-submenu' class='submenu' style='display: none;'>
                                    <div class='left'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href='$ip/administrador/evaluacion.php'>Evaluacion Docente</a></li>
                                            <li><a href='$ip/administrador/faltaevadoc.php'>Falta Evaluacion Docente</a></li>
                                            <li><a href='$ip/docente20/matedoc.php' >Lista Doc</a></li>
                                            <li><a href='$ip/docente20/preguntas.php' >Preguntas</a></li>
                                            <li><a href='$ip/reporte/totalespecial.php' >Total Especiales</a></li>
                                            <li><a href='$ip/docente20/modulos.php' >Módulos</a></li>
                                            <li><a href='$ip/administrador/cuentasus.php' >Usuarios</a></li>
                                        </ul>
                                    </div>
                                   <div class='left'>
                                        <h3>Materias</h3>
                                   ...
                                   <div class='left'>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href='$ip/administrador/altaperiodo.php'>Agregar ordinario </a></li>
                                            <li><a href='$ip/administrador/altaperiodov.php'>Agregar Verano </a></li>
							...
							<li><a href='#' >Servicios</a>   
								...
								<div class='submenu'> 
                                    ...
                                    <ul>
										...
										<li><a href='$ip/auditoria/programa.php'>Programa Anual</a></li>

										<li><a href='$ip/auditoria/altaserv.php'>Alta de servicio</a></li>
...

				{
...

					{
...

						{
							...
							<header id='titulo'> División de Estudios Profesionales: $d->nomd    Periodo: $p->descper</header>
							                    ...
							                    <div id='nav-bar'>
							                        ...
							                        <ul>
													   ...
													   <li> <a href='#' class=''>Configuración</a>    
                                                        ...
                                                        <li><a href='$ip/administrador/moduser.php?id=$d->idsub&nombre=$d->nomsub&tabla=subdireccion&atributo=passub&idt=idsub' >Contraseña</a></li>
														<li><a href='$ip/cerrarsesion.php' >Cerrar Sesión</a></li>

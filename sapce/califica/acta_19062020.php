  ...
  <div id="registros">
    ...
    <table>
      ...
      <tr>
        ...
        <td widtd="15px" rowspan="2" align='center'>No</td>

        <td widtd="10px" rowspan="2" title="Curso ordinario" align='center'>C<br>O</td>

        <td widtd="10px" rowspan="2" title="Curso Repetición" align='center'>C<br>R</td>

        <td widtd="10px" rowspan="2" title="Curso Especial" align='center'>C<br>E</td>

        <td widtd="10px" rowspan="2" title="Curso Global" align='center'>C<br>G</td>
        <td widtd="10px" rowspan="2" title="Curso Semi Presencial" align='center'>S<br>P</td>

    	  <td widtd="90px" rowspan="2" align='center'>Matrícula</td>

        <td widtd="" rowspan="2" align='center'>NOMBRE ALUMNO </td>

        <td colspan="2" align='center'>OPORTUNIDAD</td>

        <td widtd="35px" rowspan="2" align='center'>PROM<br>F </td>

        <td widtd="15px" rowspan="2" title="Desertó" align='center'>D <br> e <br> s </td>

        <td widtd="10px" rowspan="2" align='center'> </td>

      </tr>

      <tr>

        <td widtd="35px" height="38" align='center'>P O</td>

        <td widtd="35px" align='center'>S O</th>
